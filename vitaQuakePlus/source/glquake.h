...
//int GL_LoadTexture (char *identifier, int width, int height, byte *data, bool mipmap, bool alpha);				//Diabolickal TGA
int GL_LoadTexture (char *identifier, int width, int height, byte *data, bool mipmap, bool alpha, int bytesperpixel);//Diabolickal End
